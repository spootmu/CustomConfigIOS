...
- (void)didSelectWithTableView:(UITableView *)tableView controller:(UIViewController *)controller
{
    ...
    else if ([UIAlertController class])
    {
        ...
        [alert addAction:[UIAlertAction actionWithTitle:NSLocalizedString(@"选择图片", nil) style:UIAlertActionStyleDefault handler:^(__unused UIAlertAction *action) {
    ...
    {
        self.controller = controller;
        [[[UIActionSheet alloc] initWithTitle:nil delegate:self cancelButtonTitle:NSLocalizedString(@"取消", nil) destructiveButtonTitle:nil otherButtonTitles:NSLocalizedString(@"拍照", nil), NSLocalizedString(@"选择图片", nil), nil] showInView:controller.view];
    }
}
...
//        [self.pickerView addSubview:view];
//    UIButton *btn=[[UIButton alloc]init];
//    btn.frame=CGRectMake(375-30, 0, 30, 40);
...
//{
//    UIView *view=[[UIView alloc]init];
//    view.frame=CGRectMake(0, 0, 375, 20);
//    view.backgroundColor=[UIColor blackColor];
//    [self.pickerView addSubview:view];
//}
